...
It also checks the currency of the country of origin and converts to the currency of the country you are travelling using an API called exangeRate-api. 
